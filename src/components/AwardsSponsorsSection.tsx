  ...
  return (
    <section id="awards" className="relative flex flex-col lg:flex-row min-h-[500px]">
      ...
      <div className="lg:w-1/2 p-4 md:p-8 flex items-center justify-center">
        <div className="bg-[#1B4A4A] w-full text-white py-12 px-6 lg:px-12 relative rounded-3xl shadow-2xl border-2 border-dashed border-[#C8B89A]/30 flex flex-col justify-center">
          <motion.div 
      ...
      <div className="lg:w-1/2 bg-transparent py-20 px-8 lg:px-16 flex flex-col justify-center">
         <motion.div 
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
